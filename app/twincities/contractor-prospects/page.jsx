...
export default function ContractorProspectsPage() {
  ...
  async function prioritize(name){
    setPrioritizing(name);
    try{
      const r=await fetch("/api/contractor-prospects/prioritize",{method:"POST",headers:{"content-type":"application/json"},body:JSON.stringify({businessName:name})});
      const d=await r.json();
      if(d.ok){ setSelected(d.contractor); setLeads(d.leads||[]); }
