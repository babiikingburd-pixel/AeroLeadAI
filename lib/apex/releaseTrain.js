export const APEX_RELEASES = [
  ...
  { version: '10.0', name: 'Autonomous Governance', status: 'active', capabilities: ['server-side global ranking over all leads', 'promotion streak stability gate', 'promote/demote/hold decision log', 'cycle telemetry'] },
  { version: '10.1', name: 'Bounded Autonomy', status: 'release', capabilities: ['shared validation state machine', 'bounded retries with exponential backoff', 'one confidence definition in SQL and JS', 'configurable thresholds via twincities_apex_controls', 'paid-call cost guard with automatic kill switch', 'full environment matrix in system health'] },
];
...
export const APEX_VERSION = '10.1';
