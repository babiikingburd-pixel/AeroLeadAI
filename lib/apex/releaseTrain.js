export const APEX_RELEASES = [
  ...
  { version: '9.6', name: 'Mission Control', status: 'release', capabilities: ['unified operating dashboard', 'release health', 'pipeline telemetry', 'self-install/build controls', 'closed-loop learning visibility'] },
];

export const APEX_VERSION = '9.6';
