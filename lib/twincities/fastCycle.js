...
export const FAST_SCORE_FIELDS = [
  ...
  "review_status","sales_status","property_class","tree_score","driveway_score","damage_notes",
  "image_evidence_status","image_fetched_at","image_review_status","priority_score","confidence_score",
  "evidence_score","scored_at","validation_status","validation_score","validation_confidence",
  "validation_priority","last_validated_at","next_validation_at","evidence_cycle_at"
].join(",");
